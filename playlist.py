...
add_song(my_playlist, {'artist': 'Alicia Keys', 'title': 'If I Aint Got You'})
...
add_song(my_playlist, {'artist': 'Usher', 'title': '8701'})
add_song(my_playlist, {'artist': 'Aaliyah', 'title': 'Rock The Boat'})
